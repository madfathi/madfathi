...
if(event1.type == SDL_MOUSEBUTTONDOWN/* || event1.type == SDL_MOUSEBUTTONUP*/)
{
if(event1.button.button == SDL_BUTTON_LEFT)
{
...
if(event1.button.x>487 && event1.button.x<866 && event1.button.y >601 && event1.button.y <755 || (x>487 && x<866 && y>601 && y<755)  )
{
done =1;
}
...
if(event1.button.x>550 && event1.button.x<839  && event1.button.y > 285 && event1.button.y < 348)
{
o=1;
if(x>550 && x<839  && y>285 && y < 348 && o==1)
{
